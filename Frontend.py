...
def main():
    st.header("Selamat datang di aplikasi Pengolahan Citra!")
...
#------------convert BGR to RGB-------------
        ...
        option = st.selectbox('Pilih filter yang akan digunakan',('Select','Edge Detection','Grayscale','Negative Transformation','Gaussian Blur','Reduce Noise','Sharping'))
